...
Outer.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Open.Name = "Open"
Open.Parent = Outer
Open.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Open.Position = UDim2.new(0.0143076144, 0, 0.505917132, 0)
Open.Size = UDim2.new(0, 116, 0, 35)

ScreenGui.Parent = Outer
...
OPENN.Size = UDim2.new(0, 116, 0, 35)
OPENN.Font = Enum.Font.SourceSans
OPENN.Text = "Open"
OPENN.TextColor3 = Color3.fromRGB(0, 0, 0)
OPENN.TextSize = 14.000

OPENN.MouseButton1Down:Connect(function()
	ScreenGui.Enabled = true
end)

Frame.Parent = ScreenGui
Frame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Frame.Position = UDim2.new(0.232498705, 0, 0.42899406, 0)
Frame.Size = UDim2.new(0, 356, 0, 232)

TextButton.Parent = Frame
TextButton.BackgroundColor3 = Color3.fromRGB(51, 255, 92)
TextButton.Position = UDim2.new(0.54494381, 0, 0.25431031, 0)
TextButton.Size = UDim2.new(0, 119, 0, 45)
...
TextButton_2.BackgroundColor3 = Color3.fromRGB(51, 255, 92)
TextButton_2.Position = UDim2.new(0.109550565, 0, 0.25431031, 0)
TextButton_2.Size = UDim2.new(0, 119, 0, 45)
TextButton_2.Font = Enum.Font.SourceSans
TextButton_2.Text = "Reviz Admin"
...
E.Name = "E"
E.Parent = Frame
E.BackgroundColor3 = Color3.fromRGB(51, 255, 92)
E.Position = UDim2.new(0.109550565, 0, 0.487068951, 0)
E.Size = UDim2.new(0, 119, 0, 45)
...
E.MouseButton1Down:Connect(function()
	...
	local ScrnFrm = Instance.new("Frame",Gui)
	local Box1 = Instance.new("TextBox",ScrnFrm)
	local Box2 = Instance.new("TextBox",ScrnFrm)
	local Box3 = Instance.new("TextBox",ScrnFrm)
	local TitleLabel = Instance.new("TextLabel",ScrnFrm)
	local PosLabel = Instance.new("TextLabel",ScrnFrm)
	local Close = Instance.new("TextButton",ScrnFrm)
	Close.Name = "Close"
	Close.Text = "X"
	...
	TitleLabel.Text = "Enter Position Below"
	Box1.Name = "One"
	Box2.Name = "Two"
	Box3.Name  = "Three"
	Box1.Text = "0"
	...
	ScrnFrm.Size = UDim2.new(0, 255,0, 84)
	ScrnFrm.Position = UDim2.new(0.728, 0,0.376, 0)
	ScrnFrm.BorderSizePixel = 0
	Box1.Size = UDim2.new(0, 61,0, 16)
	Box1.Position = UDim2.new(0.07, 0,0.5, 0)
	Box2.Size = UDim2.new(0, 61,0, 16)
	Box2.Position = UDim2.new(0.38, 0,0.5, 0)
	Box3.Size = UDim2.new(0, 61,0, 16)
	Box3.Position = UDim2.new(0.68, 0,0.499, 0)
	TitleLabel.Position = UDim2.new(0.254, 0,0.071, 0)
	TitleLabel.Size = UDim2.new(0, 125,0, 27)
	PosLabel.Size = UDim2.new(0, 237,0, 19)
	PosLabel.Position = UDim2.new(0, 0,0.69, 0)
	Close.TextColor3 = Color3.fromRGB(255, 0, 0)
	Close.Position  = UDim2.new(-0.001, 0,0.06, 0)
	Close.Size = UDim2.new(0, 35,0, 16)
	Close.TextColor3 = Color3.fromRGB(255, 0, 0)
	...
	function CheckDevice()
		if UIP.KeyboardEnabled == true then
			return "PC"
		elseif UIP.KeyboardEnabled == false then
			return "Xbox"
		end
	end

	UIP.InputBegan:Connect(function(Key, calling)
		if CheckDevice() == "PC" then
			if Key.KeyCode == Enum.KeyCode.Q  then
				game.Players.LocalPlayer.Character:WaitForChild("Head",3).CFrame = game.Players.LocalPlayer.Character:WaitForChild("Head",3).CFrame + Vector3.new(Box1.Text,Box2.Text,Box3.Text)
			end
		end

		if CheckDevice() == "Xbox" then
			if Key.KeyCode == Enum.KeyCode.ButtonA then			
				game.Players.LocalPlayer.Character.Head.CFrame = game.Players.LocalPlayer.Character.Head.CFrame + Vector3.new(Box1.Text,Box2.Text,Box3.Text)
			end
		end
	end)
	...
	local function update(input)
		...
		ScrnFrm.Position = UDim2.new(startPos.X.Scale, startPos.X.Offset + delta.X, startPos.Y.Scale, startPos.Y.Offset + delta.Y)
	end

	ScrnFrm.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
			dragging = true
			dragStart = input.Position
			startPos = ScrnFrm.Position
	...
	ScrnFrm.InputChanged:Connect(function(input)
	...
	while script.Disabled == false do
		wait()
		PosLabel.Text = tostring(game.Players.LocalPlayer.Character:WaitForChild("Head",5).Position)
	end
end)

TextButton_3.Parent = Frame
TextButton_3.BackgroundColor3 = Color3.fromRGB(51, 255, 92)
TextButton_3.Position = UDim2.new(0.54494381, 0, 0.487068951, 0)
TextButton_3.Size = UDim2.new(0, 119, 0, 45)
TextButton_3.Font = Enum.Font.SourceSans
TextButton_3.Text = "Dark Dex"
...
TextButton_4.BackgroundColor3 = Color3.fromRGB(51, 255, 92)
TextButton_4.Position = UDim2.new(0.54494381, 0, 0.711206913, 0)
TextButton_4.Size = UDim2.new(0, 119, 0, 45)
TextButton_4.Font = Enum.Font.SourceSans
TextButton_4.Text = "pending"
TextButton_4.TextColor3 = Color3.fromRGB(0, 0, 0)
TextButton_4.TextSize = 14.000

TextButton_5.Parent = Frame
TextButton_5.BackgroundColor3 = Color3.fromRGB(51, 255, 92)
TextButton_5.Position = UDim2.new(0.109550565, 0, 0.711206913, 0)
TextButton_5.Size = UDim2.new(0, 119, 0, 45)
TextButton_5.Font = Enum.Font.SourceSans
TextButton_5.Text = "pending"
...
CLOSE.Position = UDim2.new(0.910112381, 0, 0, 0)
CLOSE.Size = UDim2.new(0, 32, 0, 31)
